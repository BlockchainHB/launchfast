          ...
          <TableHeader>
            <TableRow className="bg-muted/50">
              ...
              <TableHead className="sticky left-0 z-30 bg-muted backdrop-blur-sm shadow-lg border-r w-80">
                <div className="animate-pulse bg-muted-foreground/20 rounded h-4 w-24"></div>
              </TableHead>
              {/* Other columns */}
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-3 min-w-[300px]">
                      ...
                      <div className="space-y-1">
                        <div className="animate-pulse bg-muted rounded h-4 w-48"></div>
                        <div className="flex items-center space-x-2">
                          <div className="animate-pulse bg-muted rounded h-3 w-20"></div>
                          <div className="animate-pulse bg-muted rounded h-3 w-3"></div>
                        </div>
